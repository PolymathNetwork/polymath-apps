...
export const SvgPoly2 = (props: React.SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" {...props}>
    <defs>
      <circle id="poly-2_svg__a" cx={12.5} cy={12.5} r={12.5} />
    </defs>
    <g fill="none" fillRule="evenodd">
      <mask id="poly-2_svg__b" fill="#fff">
        <use xlinkHref="#poly-2_svg__a" />
      </mask>
      <use fill="#C1E6FE" xlinkHref="#poly-2_svg__a" />
      <path
        fill="#3C6586"
        fillRule="nonzero"
        mask="url(#poly-2_svg__b)"
