...
describe('Reducer: app', () => {
  ...
  test('setActiveTransactionQueue sets activeTransactionQueue', () => {
    const id = 'someId';
    const result = reducer(undefined, actions.setActiveTransactionQueue(id));
    expect(result.activeTransactionQueue).toEqual(id);
  });
