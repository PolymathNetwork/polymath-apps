...
import { etherscanTx } from '@polymathnetwork/ui';
      ...
      <Email>
        ...
        <div className="icon-text tx-hash">
          <div className="icon">
            <img
              alt="Icon"
              src="https://polymath-offchain.herokuapp.com/img/checkmark.png"
            />
          </div>
          <h2>You can view the transaction details here:</h2>
          <div className="tx">
            Transaction details on Etherscan: {etherscan}
          </div>
        </div>
        <div className="icon-text" style={{ height: '78px' }}>
          <div className="icon">
            <img
              alt="Icon"
              src="https://polymath-offchain.herokuapp.com/img/warning.png"
            />
          </div>
          <h2>
            Your reservation is valid for{' '}
            <strong>{this.props.expiryLimit}</strong> days.
            <br />
        ...
        <div className="text">
          ...
          <ul>
            ...
            <li>
              additional information should be embedded into your token, such as
              a legend or link to your investor relations site.
            </li>
          </ul>
          <p>
            If you are unsure of the above, please consult with your advisors or
            engage an advisory firm through the Polymath Token Studio
            marketplace before your reservation period expires.
          </p>
          <p align="center">
            <a
              href={
                window.location.origin + '/dashboard/' + ticker + '/providers'
              }
            >
